...
<class=" d-flex flex-column">
    ...
    <div class="page page-center bg-cyan">
        <div class="container container-normal py-4">
            <div class="row align-items-center g-4">
                <div class="col-lg">
                    <div class="container-tight">
                        <div class="text-center mb-0">
                            <a href="." class="navbar-brand navbar-brand-autodark"><img src="<?= base_url('assets/img/logo.png') ?>" height="110" alt=""></a>
                        </div>
                ...
                <div class="col-lg d-none d-lg-block">
                    <img src="<?= base_url('assets/img/work.jpg') ?>" width="800" height="450" class="d-block mx-auto" alt="ilustrasi">
                </div>
            </div>
        </div>
    </div>
