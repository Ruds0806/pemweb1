...
if (isset($_POST['submit'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (!empty($pesan_kesalahan)) {
            ...
            $result = mysqli_query($conn, "INSERT INTO lokasi_presensi(nama_lokasi, alamat_lokasi, tipe_lokasi, latitude, longitude, radius, zona_waktu, jam_masuk, jam_pulang) VALUES ('$nama_lokasi', '$alamat_lokasi', '$tipe_lokasi', '$latitude', '$longitude','$radius', '$zona_waktu', '$jam_masuk', '$jam_pulang')");
