                ...
                <div class="container-xl">
                    ...
                    <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
                        <a href="../home/home.php">
                            <img src="<?= base_url('./assets/img/logo.png') ?>" alt="logo.svg"> <!-- class="navbar-brand-image" -->
                        </a>
                    </h1>
                    <div class="navbar-nav flex-row order-md-last">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                                <span class="avatar avatar-lg" style="background-image: url('<?= base_url('assets/img/foto_pegawai/' . $pegawai['foto']) ?>')"></span>
                            ...
                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                <a href="<?= base_url('admin/fitur_lainya/profile.php') ?>" class="dropdown-item">Profile</a>
                                <a href="<?= base_url('admin/fitur_lainya/ubah_password.php') ?>" class="dropdown-item">Ubah Password</a>
