...
$file = 'masuk' . date('Y-m-d') . date('H-i-s') . '.png';
file_put_contents($nama_file, $data);

$result = mysqli_query($conn, "INSERT INTO presensi(id_pegawai, tanggal_masuk, jam_masuk, foto_masuk) VALUES ('$id_pegawai','$tanggal_masuk','$jam_masuk', '$file')");
