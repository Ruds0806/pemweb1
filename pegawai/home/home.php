        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card text-center h-100">
                    ...
                    <div class="card-body">
                        ...
                        $cek_presensi_masuk = mysqli_query($conn, "SELECT * FROM presensi WHERE id_pegawai = '$id_pegawai' AND tanggal_masuk = '$tanggal_hari_ini'"); ?>
                        ...
                        <?php if (mysqli_num_rows($cek_presensi_masuk) == 0) { ?>
                            ...
                            <form method="POST" action="<?= base_url('pegawai/presensi/presensi_masuk.php') ?>">
                                ...
                                <button type="submit" name="tombol_masuk" class="btn btn-primary mt-2">Masuk</button>
                            </form>
                        <?php } else { ?>
                            <i class="fa-regular fa-calendar-check fa-4x text-success"></i>
                            <h4 class="my-3"> Anda Telah <br>Presensi Masuk</h4>
                        <?php } ?>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card text-center h-100">
                    ...
                    <div class="card-body">
                        <?php $ambil_data_presensi = mysqli_query($conn, "SELECT * FROM presensi WHERE id_pegawai='$id_pegawai' AND tanggal_masuk='$tanggal_hari_ini'") ?>
                        ...
                        <?php } elseif (strtotime($waktu_sekarang) >= strtotime($jam_pulang) && mysqli_num_rows($ambil_data_presensi) == 0) { ?>
                            <i class="fa-solid fa-calendar-xmark fa-4x text-danger"></i>
                            <h4 class="my-3"> Silahkan Presensi Masuk <br>Terlebih Dahulu</h4>
                        <?php } else { ?>
                            ...
                            <?php while ($cek_presensi_keluar = mysqli_fetch_array($ambil_data_presensi)) { ?>
                                ...
                                <?php if (($cek_presensi_keluar['tanggal_masuk']) && $cek_presensi_keluar['tanggal_keluar'] == '0000-00-00') { ?>
                                    ...
                                    <form method="POST" action="<?= base_url('pegawai/presensi/presensi_keluar.php') ?>">
                                        ...
                                        <button type="submit" name="tombol_keluar" class="btn btn-danger mt-2">keluar</button>
                                    </form>
...
<script>
    ...
    function getLocation() {
        if (navigator.geolocation) {
            ...
            alert("Browser Anda Tidak Mendukung Geo Location")
        }
    }
