...
if (isset($_POST['update'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (!empty($pesan_kesalahan)) {
            ...
            $result = mysqli_query($conn, "UPDATE ketidakhadiran SET keterangan='$keterangan', deskripsi='$deskripsi', tanggal='$tanggal', file='$nama_file' WHERE id = $id ");
...
$id = $_GET['id'];
$result = mysqli_query($conn, "SELECT * FROM ketidakhadiran WHERE id=$id");
