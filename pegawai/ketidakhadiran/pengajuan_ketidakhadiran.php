...
if (isset($_POST['submit'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (!empty($pesan_kesalahan)) {
            ...
            $result = mysqli_query($conn, "INSERT INTO ketidakhadiran(id_pegawai, keterangan, deskripsi, tanggal, status_pengajuan, file) VALUES ('$id', '$keterangan', '$deskripsi', '$tanggal', '$status_pengajuan','$nama_file')");
